...
bot = telebot.TeleBot('7921815407:AAEU7GIuywu8LOc5YQseSYcbA9hQTDmUpV0')
...
def welcome_start(message):
    ...
    response = f'''🙏 TABISH PAID BOT BY @HACK_CHIYE 🙏'''
    bot.reply_to(message, response)
